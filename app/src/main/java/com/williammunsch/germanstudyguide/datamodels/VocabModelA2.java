...
@Entity(tableName = "vocab_tableA2")
public class VocabModelA2 {
    @PrimaryKey
    private int _id;
    ...
    public VocabModelA2(int id, String german, String english, String gsentence, String esentence, int studying, String article){//}, int score, int freq, int studying){
        this._id = id;
        this.german = german;
